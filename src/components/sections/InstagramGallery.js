      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        <RevealOnScroll mode="fade-in-up" delay={0}>
          <Card3DTilt className="aspect-square rounded-2xl overflow-hidden shadow-md group cursor-pointer relative">
            <img src="/image/webp/modal5.webp" alt="Insta 1" className="w-full h-full object-cover group-hover:scale-110 group-hover:opacity-80 transition-all duration-500" />
        ...
        <RevealOnScroll mode="fade-in-up" delay={120}>
          <Card3DTilt className="aspect-square rounded-2xl overflow-hidden shadow-md group cursor-pointer relative">
            <img src="/image/webp/necklace2.webp" alt="Insta 2" className="w-full h-full object-cover group-hover:scale-110 group-hover:opacity-80 transition-all duration-500" />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-white">
              <IconInstagram className="w-8 h-8" />
            </div>
          </Card3DTilt>
        ...
        <RevealOnScroll mode="fade-in-up" delay={240}>
          <Card3DTilt className="aspect-square rounded-2xl overflow-hidden shadow-md group cursor-pointer relative">
            <img src="/image/webp/bracelet1.webp" alt="Insta 3" className="w-full h-full object-cover group-hover:scale-110 group-hover:opacity-80 transition-all duration-500" />
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity text-white">
              <IconInstagram className="w-8 h-8" />
            </div>
          </Card3DTilt>
