...
const ateliers = [
  ...
  { city: "Gold, Diamond & Gemstone Jewellery", note: "Certified Gemstones", image: "/image/gr/all/1/ring5.png" },
];
  ...
  return (
    <section className="py-24 px-6 lg:px-16 max-w-7xl mx-auto">
      <RevealOnScroll mode="fade-in-up" className="text-center max-w-xl mx-auto mb-16">
        ...
        <h2 className="text-4xl sm:text-5xl font-serif font-light text-[#1B4341]">
          <TextSplitReveal text="What We Specialise In" type="words" />
        </h2>
      </RevealOnScroll>
