  ...
  return (
    ...
    >
      <RevealOnScroll mode="fade-in-up" className="max-w-3xl mx-auto text-center">
        ...
        <h2 className="text-4xl sm:text-6xl font-serif font-light leading-tight">
          <TextSplitReveal text="Design Your Custom Jewellery With GR Jewellers" type="words" />
        </h2>
        <p className="mt-6 text-sm sm:text-base text-zinc-300 font-light max-w-lg mx-auto leading-relaxed">
          Looking for bespoke jewellery, custom engagement rings, wedding jewellery, or
          certified diamond and gemstone designs? Visit our showroom and let our experts
