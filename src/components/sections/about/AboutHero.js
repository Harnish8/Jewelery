...
const stats = [
  { icon: IconAward, value: "100+", label: "Years of Heritage" },
  { icon: IconGem, value: "4th", label: "Generation Family" },
  { icon: IconLeaf, value: "2003", label: "Est. Anand, Gujarat" },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-serif font-light text-[#1B4341] leading-[1.08] tracking-tight">
              <TextSplitReveal text="A Century of" type="words" delay={200} />
              <br />
              <TextSplitReveal text="Craftsmanship, Trust" type="words" delay={380} />
              <br />
              <TextSplitReveal text="& Timeless Elegance" type="words" delay={560} />
            </h1>

            <RevealOnScroll mode="fade-in-up" delay={800}>
              <p className="mt-8 text-base sm:text-lg text-[#666] font-light max-w-lg leading-relaxed">
                Founded on generations of passion for fine jewellery, GR Jewellers has proudly
                served Anand, Gujarat, with exceptional craftsmanship, trusted quality, and
                personalised service. Today, our fourth generation continues this legacy,
                creating exquisite gold, silver, diamond, gemstone, and custom jewellery that
