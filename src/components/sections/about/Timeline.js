...
const milestones = [
  { year: "Pre-2003", title: "The Beginning of Our Legacy", copy: "The Soni family's journey in jewellery craftsmanship begins, laying the foundation for over 100 years of trust, quality, and traditional artistry." },
  { year: "2003", title: "GR Jewellers Established", copy: "GR Jewellers is officially established in Anand, Gujarat, by Hasmukh Gordhan Soni and Rajeshbhai Hasmukhbhai Soni, bringing generations of craftsmanship into a modern jewellery showroom." },
  { year: "Growing Through Trust", title: "Expanding Our Reputation", copy: "With a commitment to purity, honest craftsmanship, and personalised service, GR Jewellers earns the trust of families across Anand and surrounding regions." },
  { year: "Modern Expertise", title: "Innovation Meets Tradition", copy: "The brand expands its expertise with GIA-certified gemology, custom jewellery design, diamonds, gemstones, colour stones, platinum, and lab-grown diamonds while preserving traditional craftsmanship." },
  { year: "Today", title: "Fourth Generation of Excellence", copy: "Led by Kevin Rajeshbhai Soni, GR Jewellers proudly carries forward a century-old legacy, creating bespoke jewellery and timeless heirlooms for customers in India and NRIs across the UK, USA, and Australia." },
];
  ...
  return (
    <section className="py-24 px-6 lg:px-16 max-w-5xl mx-auto border-t border-[#EADFC9]">
      <RevealOnScroll mode="fade-in-up" className="text-center max-w-xl mx-auto mb-20">
        ...
        <h2 className="text-4xl sm:text-5xl font-serif font-light text-[#1B4341]">
          <TextSplitReveal text="A Legacy That Continues to Shine" type="words" />
        </h2>
      </RevealOnScroll>
