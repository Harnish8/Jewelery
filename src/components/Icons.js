export const IconSearch = ({ className = "w-5 h-5", strokeWidth = 1.8 }) => (
...
export const IconLeaf = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M11 20A7 7 0 0 1 4 13c0-4 3-7 7-11 4 4 7 7 7 11a7 7 0 0 1-7 7z"></path>
    <path d="M11 20v-9"></path>
  </svg>
);

export const IconGem = ({ className = "w-5 h-5" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M6 2L3 8l9 14 9-14-3-6H6z"></path>
    <path d="M3 8h18"></path>
    <path d="m6 2 6 6-6 6"></path>
    <path d="m18 2-6 6 6 6"></path>
  </svg>
);
